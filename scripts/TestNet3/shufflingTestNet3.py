...
#urls3 = random.choice([url32, url33, url34, url35, url31])
# Test Net 2
...
while alive:
    ...
    response = requests.request("POST", urls3, params=querystring)
    print(response.json())
    ...
    for k in range(1, 35):
        ...
        response = requests.request("POST", urls3,
