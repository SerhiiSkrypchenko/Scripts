...
for j in range(0, 10000000000000000000000000000000000000000):
    ...
    for k in range(1, 201):
        ...
        createAliasURL = {"requestType": "setAlias", "aliasName": aliasname,
                          ...
                          "deadline": "1440"}
        response = requests.request("POST", urls2, params=createAliasURL)
        print(response.text)
        ...
        createAliasURL1 = {"requestType": "setAlias", "aliasName": aliasname1,
                           ...
                           "sender": accountSender,
                           "deadline": "1440"}
        response = requests.request("POST", urls2, params=createAliasURL1)
        print(response.text)
        ...
        createAliasURL2 = {"requestType": "setAlias", "aliasName": aliasname2,
                           ...
                           "sender": accountSender,
                           "deadline": "1440"}
        response = requests.request("POST", urls2, params=createAliasURL2)
        print(response.text)
        ...
        while z <= 30:
            ...
            response = requests.request("POST", urls2, params=deleteAlias)
            print(response.json())
        ...
        while z <= 30:
            ...
            transferAlias = {"0": "1", "1": "2", "2": "6", "3": "5", "4": "3", "5": "0", "6": "5", "7": "5", "8": "2",
                             ...
                             "sender": accountSender,
                             "deadline": "1440"}
            response = requests.request("POST", urls2, params=transferAlias)
            print(response.json())
