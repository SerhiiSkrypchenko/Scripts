...
source = "class MyAPL20PersonalLockable extends APL20PersonalLockable {\n      constructor(){\n          super('New Search BUG','New Search BUG','2000000000000','0','100000000','0','0x82349393da8764fd');\n      }\n    }"
source_1 = "class MyAPL20PersonalLockable extends APL20PersonalLockable {\n      constructor(){\n          super('New Search BUG 1','New Search BUG 1','2000000000000','0','100000000','0','0x82349393da8764fd');\n      }\n    }"
source_2 = "class MyAPL20PersonalLockable extends APL20PersonalLockable {\n      constructor(){\n          super('New Search BUG 2','New Search BUG 2','2000000000000','10000000000','10000000','0','0x38f700676cdf50bc');\n      }\n    }"
source_3 = "class MyAPL20PersonalLockable extends APL20PersonalLockable {\n      constructor(){\n          super('New Search BUG 3','New Search BUG 3','2000000000000','20000000000','1000000','0','0x82349393da8764fd');\n      }\n    }"
source_4 = "class MyAPL20PersonalLockable extends APL20PersonalLockable {\n      constructor(){\n          super('New Search BUG 4','New Search BUG 4','2000000000000','30000000000','100000','0','0x82349393da8764fd');\n      }\n    }"
...
sc_Address = "6256410506792331928"
sc_Address_1 = "16876091394825685896"
sc_Address_2 = "17508734527544301228"
sc_Address_3 = "10575553198832067454"
sc_Address_4 = "15354761732411322996"
