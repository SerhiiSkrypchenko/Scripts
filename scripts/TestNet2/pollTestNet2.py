...
j = 0
for j in range(0, 10000000000000000000000000000000000000000000000000000):
    print("------------------------------   " + str(j) + "   ----------------------------------")
    pollByAccountId = {"name": "ApolloInFuture", "votingModel": "0", "finishHeight": "40000", "minNumberOfOptions": "1",
