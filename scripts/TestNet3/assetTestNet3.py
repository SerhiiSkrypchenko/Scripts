...
while alive:
    ...
    response = requests.request("POST", urls3, params=createAsset)
    ...
    for k in range(0, 100):
        ...
        response = requests.request("GET", urls3,
                                    params=getAccountId)
        print(response.json())
        ...
        response = requests.request("POST", urls3, params=transferAsset)
        print(response.text)
        ...
        while i <= 10:
            ...
            response = requests.request("POST", urls3, params=deleteAsset)
            print(response.text)
